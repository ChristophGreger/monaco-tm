...
export const KEYWORD_HOVERS: Record<string, string> = {
  ...
  halt: 'Marks this state as a halting state. A halt state cannot contain transitions.',
  ...
  and: 'Combines condition atoms. `or` is reserved but not supported by this DSL.',
